...
const AskQuestion = () => {
  ...
  return (
    <div className="w-full smd:h-[140vh]">
      <h4 className="text-[#413e66] text-[36px] font-bold text-center pt-10">Frequently Asked Questions</h4>
       <p className="text-[#535074] text-center pt-3 p-2 md:p-0">Team with a strong tech experience who always gets your work done.</p>
